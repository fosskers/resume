...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  ...
  \href{https://www.fosskers.ca/en/cv}{https://www.fosskers.ca/en/cv} & Mobile : +81-80-2663-3766\\
\end{tabular*}
...
\item{\textbf{Languages}{: C, Rust, Haskell, Go, Python, Lisp/Clojure}}
\item{\textbf{Web Technologies}{: Terraform, GraphQL, AWS, GCS, Docker, Web Assembly}}
\item{\textbf{Other}{: Linux, Git, SQL, Apache Spark}}
...
\resumeSubheading
    ...
    \resumeItem{Rust Mentorship}{Hosted in-house study sessions and trained developers new to Rust.}
    \resumeItemListEnd

\resumeSubheading
    {Freelance Software Development}{Vancouver, Canada}
    {Software Development for Various Clients (Remote)}{2020 May - 2022 August}
    \resumeItemListStart
...
\resumeSubItem{\href{https://sr.ht/~fosskers/transducers/sources}{Transducers}}{(Lisps) Efficient, ergonomic data streaming algorithms.}
...
\section{Hobbies}
\resumeSubHeadingListStart
\resumeSubItem{Open Source Development}{Aura, Rust/Haskell/Lisp libraries, minor contributions to Emacs ecosystem.}
\resumeSubItem{Sports}{Rock Climbing, Golf, and Snowboarding.}
