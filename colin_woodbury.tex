...
\resumeSubheading
  {Kadena}{アメリカ・ニューヨーク}
  {Haskell 開発}{２０１８年８月から２０２０年５月まで}
  \resumeItemListStart
  \resumeItem{バックエンド開発}{Core developer of the Kadena Public Blockchain (Chainweb). Designed and implemented its Difficulty Adjustment algorithm. Pioneered Chainweb's mining algorithm and wrote its client, chainweb-miner.}
  \resumeItem{システム管理}{Worked as the main system administrator for Kadena web servers. Managed servers on AWS with Terraform and NixOS.}
  \resumeItem{ドキュメンテーション}{Wrote extensive documentation in both Japanese and English.}
  \resumeItem{会社代表}{Represented the company as a speaker at conferences in Japan, the USA, and Canada.}
  \resumeItemListEnd
